...
struct CssPropertyFlags {
  ...
  uint32_t fontVariantSmallCaps : 1;
  ...
  CssPropertyFlags()
      : textAlign(0),
        ...
        verticalAlign(0),
        lineHeight(0),
        fontVariantSmallCaps(0),
        initialLetter(0) {}

  [[nodiscard]] bool anySet() const {
    return textAlign || fontStyle || fontWeight || textDecoration || textIndent || marginTop || marginBottom ||
           marginLeft || marginRight || paddingTop || paddingBottom || paddingLeft || paddingRight || imageHeight ||
           imageWidth || display || direction || verticalAlign || lineHeight || fontVariantSmallCaps || initialLetter;
  }
  ...
  void clearAll() {
    ...
    imageHeight = imageWidth = display = direction = verticalAlign = lineHeight = fontVariantSmallCaps = initialLetter = 0;
  }
};
...
struct CssStyle {
  ...
  CssLength lineHeight;     // CSS line-height, resolved later for numeric values
  ...
  float initialLetter = 0.0f;  // `initial-letter` requests a drop cap when > 0
  ...
  void applyOver(const CssStyle& base) {
    ...
    if (base.hasFontVariantSmallCaps()) {
      fontVariantSmallCaps = base.fontVariantSmallCaps;
      defined.fontVariantSmallCaps = 1;
    }
    if (base.hasInitialLetter()) {
  ...
  [[nodiscard]] bool hasFontVariantSmallCaps() const { return defined.fontVariantSmallCaps; }
  [[nodiscard]] bool hasInitialLetter() const { return defined.initialLetter; }
