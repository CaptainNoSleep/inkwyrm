...
class CrossPointSettings {
 ...
 public:
  ...
  uint8_t statusBarCompactInfo = 0;
  ...
  // Reader-only dark rendering. Grayscale/image pages stay light in v1.
  ...
  uint32_t lastKoSyncEpoch = 0;
  // KOReader Sync automation. Disabled by default to preserve manual sync behavior.
