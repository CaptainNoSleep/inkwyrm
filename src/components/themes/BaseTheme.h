...
class BaseTheme {
 public:
  ...
  void drawStatusBar(GfxRenderer& renderer, const float bookProgress, const int currentPage, const int pageCount,
                     ...
                     const int estimatedMinutesLeft = -1, const float* chapterTicksProgress = nullptr,
                     const int chapterTicksCount = 0) const;
  ...
  void drawCompactInfoBar(GfxRenderer& renderer, float bookProgress, int currentPage, int pageCount,
                          const std::string& title, int paddingBottom, int orientedMarginBottom,
                          int orientedMarginLeft, int orientedMarginRight, int estimatedMinutesLeft,
                          const float* chapterTicksProgress, int chapterTicksCount) const;
};
