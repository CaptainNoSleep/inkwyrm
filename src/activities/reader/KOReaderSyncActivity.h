...
enum class KOReaderSyncLaunchMode : uint8_t { COMPARE, AUTO_PULL, AUTO_PUSH };
...
class KOReaderSyncActivity final : public Activity {
 public:
  explicit KOReaderSyncActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, const std::string& epubPath,
                                ...
                                KOReaderSyncLaunchMode launchMode = KOReaderSyncLaunchMode::COMPARE)
 ...
 private:
  ...
  KOReaderSyncLaunchMode launchMode;
  ...
  void returnToReader();
  void returnToHome();
  bool isAutomatic() const { return launchMode != KOReaderSyncLaunchMode::COMPARE; }
};
