...
const StrId menuNames[MENU_ITEMS] = {StrId::STR_USERNAME,          StrId::STR_PASSWORD,
                                     ...
                                     StrId::STR_KO_AUTO_PULL_ON_OPEN, StrId::STR_KO_AUTO_PUSH_ON_CLOSE,
  ...
  GUI.drawList(
      ...
      [this](int index) {
        ...
        if (index == 0) {
          ...
          return std::string(SETTINGS.koSyncAutoPullOnOpen ? tr(STR_ENABLED) : tr(STR_DISABLED));
        } else if (index == 5) {
          return std::string(SETTINGS.koSyncAutoPushOnClose ? tr(STR_ENABLED) : tr(STR_DISABLED));
        } else if (index == 6) {
