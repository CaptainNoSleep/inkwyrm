...
void StatusBarSettingsActivity::onEnter() {
  ...
  if (SETTINGS.statusBarCompactInfo > 1) {
    SETTINGS.statusBarCompactInfo = 0;
  }
...
void StatusBarSettingsActivity::handleSelection() {
  switch (selectedIndex) {
    ...
    case ITEM_BATTERY:
      ...
      break;
    case ITEM_COMPACT_INFO:
      SETTINGS.statusBarCompactInfo = (SETTINGS.statusBarCompactInfo + 1) % 2;
      break;
  ...
  GUI.drawList(
      ...
      [](int index) -> std::string {
        switch (index) {
          ...
          case ITEM_COMPACT_INFO:
            return SETTINGS.statusBarCompactInfo ? tr(STR_SHOW) : tr(STR_HIDE);
          case ITEM_XTC_STATUS_BAR:
