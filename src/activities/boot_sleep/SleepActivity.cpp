...
void SleepActivity::renderDefaultSleepScreen() const {
  ...
  constexpr int logoWidth = INKWYRM_MARK_WIDTH;
  constexpr int logoHeight = INKWYRM_MARK_HEIGHT;
  const int logoX = (pageWidth - logoWidth) / 2;
  const int logoY = (pageHeight - logoHeight) / 2;

  renderer.clearScreen();
  renderer.drawIcon(InkWyrmMark, logoX, logoY, logoWidth, logoHeight);
