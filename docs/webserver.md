...
This guide explains how to use InkWyrm Reader's built-in web server for file
...
| **Calibre Wireless** | You want to receive books from the CrossPoint Calibre plugin (compatible with InkWyrm) workflow. |
...
CrossPoint Calibre plugin (compatible with InkWyrm) or other clients that speak the documented WebSocket
upload protocol.
